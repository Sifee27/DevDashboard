  ...
  return (
    <div className={`relative ${className}`}>
      ...
      {isOpen && (
        <>
          <div 
            className="fixed inset-0 bg-black bg-opacity-20 dark:bg-opacity-50 z-[999]" 
            onClick={() => setIsOpen(false)}
            aria-hidden="true"
          />
          <div className="fixed right-0 mt-2 w-72 p-4 bg-white dark:bg-gray-800 rounded-md shadow-lg border border-gray-200 dark:border-gray-700 z-[1001] max-h-[80vh] overflow-y-auto" style={{ top: '80px' }}>

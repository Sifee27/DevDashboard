                ...
                <div className="flex space-x-2">
                    ...
                    <div className="mr-2 flex rounded-md overflow-hidden border border-gray-200 dark:border-gray-700">
                        <button
                            ...
                            className={`px-2 py-1 text-xs transition-all ${activeTab === 'notes'
                        ...
                        <button
                            ...
                            className={`px-2 py-1 text-xs transition-all ${activeTab === 'commands'
                                    ? 'bg-theme-primary text-white'
                                    : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300'
                                }`}
                        >
                    ...
                    {activeTab === 'notes' && (
                        <>
                            <button
                                ...
                                className={`px-2 py-1 text-xs rounded-md transition-all ${viewMode === 'edit'
                                        ? 'bg-theme-primary text-white'
                                        : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`px-2 py-1 text-xs rounded-md transition-all ${viewMode === 'preview'
                                        ? 'bg-theme-primary text-white'
                                        : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300'
                                    }`}
                            >
